...
public class HighlightController : MonoBehaviour
{
    ...
    public void SelectObject(HighlightObject highlightObject)
    {
        ...
        {
            photonView.RPC("stopHighightChild", PhotonTargets.All, highlightObject.name);
            labelPanel.gameObject.SetActive(false);
        ...
        else
        {
            ...
            {
                photonView.RPC("stopHighightChild", PhotonTargets.All, this.highlightObject.name);
            }

            this.highlightObject = highlightObject;
            labelPanel.textbox.text = this.highlightObject.name;
            photonView.RPC("startHighightChild", PhotonTargets.All, this.highlightObject.name);
